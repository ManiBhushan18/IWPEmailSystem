...
<%	
		...
		{	Date d= new Date();
			...
			ps=con.prepareStatement("select * from trash order by messid desc");
			rs=ps.executeQuery();
%>
<form method="POST" action="deletetrash1.jsp">
...
<%		
			...
			<td width="162"><a href="readtrashmess1.jsp?mid=<%= rs.getInt(1)%> "><%= rs.getString("subject") %></a></td>
